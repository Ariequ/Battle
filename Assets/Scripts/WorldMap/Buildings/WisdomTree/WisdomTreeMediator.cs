...
public class WisdomTreeMediator : UIMediator
{
    new public static String NAME = "WisdomTreeMediator";

    public const string PANEL_PATH = "UI/Legend/WisdomTree/WisdomTreeUI";

    public const int ID = 5;

    private WisdomTreeView view;

    public WisdomTreeMediator() : base (NAME)
    {
    }
    ...
    {
		view = popupManagerDelegate.CreateAndAddPopup(PANEL_PATH) as WisdomTreeView;
	...
	{
		UIEventListener.Get(view.visitButton.gameObject).onClick = onVisitButtonClick;
