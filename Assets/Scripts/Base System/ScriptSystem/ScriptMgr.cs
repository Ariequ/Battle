...
public class ScriptEnv
{
    ...
    void RegTypes()
    {
        ...
        scriptEnv.RegType(new CSLE.RegHelper_Type(typeof(Resources)));
        ...
        scriptEnv.RegType(new CSLE.RegHelper_DeleAction<int,ILimitFuncitonContext>(typeof(Action<int,ILimitFuncitonContext>), "Action<int,ILimitFuncitonContext>")); 

        scriptEnv.RegType(new CSLE.RegHelper_Type(typeof(Rect)));
        scriptEnv.RegType(new CSLE.RegHelper_Type(typeof(PrimitiveType)));


        scriptEnv.RegType(new CSLE.RegHelper_Type(typeof(ILimitFuncitonContext)));
//        scriptEnv.RegType(new CSLE.RegHelper_DeleAction<int,ILimitFuncitonContext>(typeof(LimitFunctionNode.ChildRunComplet), "LimitFunctionNode.ChildRunComplet<int,ILimitFuncitonContext>"));
    }
