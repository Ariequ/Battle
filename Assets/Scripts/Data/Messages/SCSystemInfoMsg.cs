...
namespace Hero.Message.Auto
{
  ...
  public partial class SCSystemInfoMsg : TBase
  {
    ...
    public Hero.Message.Auto.SystemInfo SystemInfo { get; set; }

    public SCSystemInfoMsg() {
    }

    public SCSystemInfoMsg(Hero.Message.Auto.SystemInfo systemInfo) : this() {
        ...
        switch (field.ID)
        {
          case 1:
            if (field.Type == TType.Struct) {
              SystemInfo = new Hero.Message.Auto.SystemInfo();
