...
namespace Hero.Message.Auto
{
  ...
  public partial class CSLoginMsg : TBase
  {
    ...
    private Hero.Message.Auto.UserPasswordLogin _userpasswordLogin;
    ...
    /// <summary>
    /// 
    /// <seealso cref="Hero.Message.Auto.Terminal"/>
    /// </summary>
    public Hero.Message.Auto.Terminal Terminal { get; set; }

    /// <summary>
    /// 
    /// <seealso cref="Hero.Message.Auto.OSType"/>
    /// </summary>
    public Hero.Message.Auto.OSType OsType { get; set; }
    ...
    public Hero.Message.Auto.UserPasswordLogin UserpasswordLogin
    {
      get
      {
    ...
    public CSLoginMsg(Hero.Message.Auto.Terminal terminal, Hero.Message.Auto.OSType osType, string osVersion, string deviceModel) : this() {
        ...
        switch (field.ID)
        {
          ...
          case 5:
            if (field.Type == TType.I32) {
              Terminal = (Hero.Message.Auto.Terminal)iprot.ReadI32();
              isset_terminal = true;
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
          ...
          case 6:
            if (field.Type == TType.I32) {
              OsType = (Hero.Message.Auto.OSType)iprot.ReadI32();
              isset_osType = true;
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
          ...
          case 20:
            if (field.Type == TType.Struct) {
              UserpasswordLogin = new Hero.Message.Auto.UserPasswordLogin();
